...
export default {
    ...
    data() {
      ...
      elements:[
        {name: "Contacts", iconUri: '../../assets/AddContact.svg', toolTip: "Some tool tip text", category: "sourcePalette", io:{
          top: {in: true, out: false}
        }},
        {name: "Events", iconUri: '../../assets/AddContact.svg', toolTip: "Some tool tip text2", category: "sourcePalette"},
        ]
      }
    },
    methods: {
      ...
      paletteTemplate(diagram){
        ...
        $(go.Node, "Table", this.nodeStyle(),
         $(go.Panel, go.Panel.Spot,  // or "Spot"
          $(go.Shape, "Circle",     {  minSize: new go.Size(40, 40),  maxSize: new go.Size(40, 40),fill: "green", alignment: new go.Spot(0.5, 0.5) }),
          $(go.Picture, { alignment: new go.Spot(0.5, 0.5),  desiredSize: new go.Size(60, 60),}, new go.Binding("source", "iconUri")),
          $(go.TextBlock, { alignment: new go.Spot(0.5, 1), margin: 8, stroke: "gray", font: "bold 16px sans-serif" },
                  new go.Binding("text", "name")),
                  makePort("L", go.Spot.Left, go.Spot.Left, true, false),
          makePort("R", go.Spot.Right, go.Spot.Right, true, false),
            {
            toolTip: $("ToolTip",{ "Border.stroke": "gray", "Border.strokeWidth": 2 },
